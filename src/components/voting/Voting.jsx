    ...
    const chairperson = [
        {
            name: "Arun Kumar",
            position: "President",
            manifesto: "Aliquam utrum nibh rutrum nibh vitae tortor dapibus egestas. Cras condimentum dapibus tellus vel semper. Quisque vel dui molestie est auctor utrum nibh porttitor."
        },
        {
            name: "Arun Kumar",
            position: "President",
